  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      {label && (
        <label
          htmlFor={inputId}
          className="text-label-medium text-m3-sys-light-on-surface dark:text-m3-sys-dark-on-surface ml-1"
        >
          {label}
        </label>
      )}
      <div className="relative flex items-center">
        {icon && (
          <div className="absolute left-4 text-m3-sys-light-on-surface-variant dark:text-m3-sys-dark-on-surface-variant shrink-0 pointer-events-none">
            {icon}
          </div>
        )}
        <input
      ...
      {error && (
        <p className="text-xs text-m3-sys-light-error dark:text-m3-sys-dark-error font-medium ml-1 mt-0.5">
          {error}
        </p>
      )}
    </div>
