        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4 max-w-7xl mx-auto w-full min-w-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0 ml-auto">
                  ...
                  <>
                    ...
                    >
                      <div className="flex items-center justify-between pb-3 border-b border-zinc-100 dark:border-zinc-800 mb-3">
                        <h3 className="font-bold text-title-medium text-m3-sys-light-on-surface dark:text-m3-sys-dark-on-surface">
                          Notifications
                        </h3>
                        <button
                          onClick={() => setIsNotificationsOpen(false)}
                          className="text-m3-sys-light-on-surface-variant hover:text-m3-sys-light-on-surface"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </div>
            ...
            <div
              ...
              title={
                isOnline ? "System Online" : "System Offline (Sync Paused)"
              }
            >
              {isOnline ? (
                <Wifi className="w-4 h-4 sm:w-3.5 sm:h-3.5 shrink-0" />
              ) : (
                <WifiOff className="w-4 h-4 sm:w-3.5 sm:h-3.5 shrink-0 animate-pulse" />
              )}
