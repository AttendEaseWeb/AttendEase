          ...
          >
            <div className="space-y-3">
              {activeSessions.length === 0 ? (
                <p className="p-6 text-center text-m3-sys-light-on-surface-variant text-body-medium">
                  No active or scheduled sessions right now.
                </p>
              ) : (
                activeSessions.map((session) => {
                  const isJHS =
                    session.category === "JUNIOR_HIGH" ||
                    session.gradeLevel <= 10;
                  return (
                    <div
                      key={session.id}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-body-small text-m3-sys-light-on-surface-variant dark:text-m3-sys-dark-on-surface-variant mt-0.5">
                            Grade {session.gradeLevel} • {session.sectionName} •{" "}
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <span className="text-title-medium font-bold text-m3-sys-light-on-surface dark:text-m3-sys-dark-on-surface">
                            ...
                            {session.totalExpectedCount}
                          </span>
                          <p className="text-label-small text-m3-sys-light-on-surface-variant">
                            Attended
                          </p>
                        </div>
